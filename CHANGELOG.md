...
- Added peak, quietest and peak ÷ average readouts beside the plot, the last being how much bandwidth headroom playback needs beyond the average, and cross-referenced the new card from the existing ⓘ explainers on both bitrate fields ([#16](https://github.com/brain-bbqs/encoding-helper/pull/16))
