...
- The Educational switch sits in the tab bar, after the tabs, as one control for the app rather than in the top corner of the first card on two tabs ([#35](https://github.com/brain-bbqs/encoding-helper/pull/35))
